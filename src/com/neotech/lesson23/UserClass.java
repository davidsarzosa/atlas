...
public class UserClass {
	...
	// if I create a parameterized constructor and do not create a default
	// constructor, that means that the user
...
class UserInfo extends UserClass {
	...
	UserInfo(String name, long mobileNumber, String userAddress) {
		...
		// super(); // if i do this, then I am calling the default constructor -- name =
		// null, mobileNumber = 0;
	...
	void userDetails() {
		...
		System.out.println("Adress --- > " + this.userAddress);
	}
