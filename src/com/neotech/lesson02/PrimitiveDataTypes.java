...
public class PrimitiveDataTypes {
	...
	public static void main(String[] args) {
		...
		// compiler will give an error// for byte baris = 145;

		short hakan2 = 2457; // range -32768 to 32767

		// compiler will give an erro
		// short var4 = 35.6;
		
		
		int viktor = -2433453; // the range -2 billion to +2 billion 
		int esar = 3; // yes I can store small numbers in an int 
		...
		long elionBankBalance = 9234528347283L;
		
		System.out.println(elionBankBalance);
		
		
		// to store decimal numbers we use float or double 
		float rahime = 23.456f; // you must use F or f a the end. 
		...
		// to store a boolean values (true/false) 
