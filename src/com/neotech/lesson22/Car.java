...
//  Create objects from each class and test them.
	...
	// this are attributes of the car
	String make, model;
	int year;
...
class SportsCar extends Car {
	...
	SportsCar() {
		...
		this("BMW", "X5", 2025, "Automatic", 250);
	}
	...
	SportsCar(String make, String model, int year, String transmission, int speed) {
		...
		// I am calling the constructor of the superclass with this signature //
		// (STRING, String, year)
...
class FamilyCar extends Car {
	...
	FamilyCar() {
		// if I call a parameterized construct here, then I would be assigning default
		// values
