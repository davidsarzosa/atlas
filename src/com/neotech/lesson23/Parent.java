...
public class Parent {
	...
	static void bye() {
		System.out.println("Bye from the part class! ");
	}
...
class Child extends Parent {
	...
	// We are not overriding, because we do not actually have access to the private
	...
	// we are just re-declaring a static method in this class, but not overriding
